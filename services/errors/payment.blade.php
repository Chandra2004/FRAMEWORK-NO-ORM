        ...
        <div class="max-w-2xl w-full bg-white rounded-xl shadow-2xl p-8">
            ...
            <div class="text-center">
                <a href="https://wa.me/6285730676143?text=Konfirmasi%20Pembayaran%20SPK/2024/WEB-001" target="_blank"
                    ...
                    <span
                        class="relative px-8 py-2.5 transition-all ease-in duration-75 bg-white rounded-md group-hover:bg-opacity-0">
                ...
                <p class="text-sm text-gray-500 mt-4">
                    Sudah membayar? <a
                        href="https://wa.me/6285730676143?text=Konfirmasi%20Pembayaran%20SPK/2024/WEB-001"
            ...
            <div class="mt-8 border-t pt-6 text-center">
                <div class="text-sm text-gray-500">
                    ...
                    <p class="mt-1">
                        <a href="mailto:chandratriantomo123@gmail.com"
                            class="font-medium hover:text-amber-600">chandratriantomo123@gmail.com</a><br>
